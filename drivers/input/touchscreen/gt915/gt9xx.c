...
static DEVICE_ATTR(disable_keys, S_IWUSR | S_IRUSR, gt9xx_disable_keys_show, gt9xx_disable_keys_store);
...
static DEVICE_ATTR(enable_dt2w, S_IWUSR | S_IRUSR, gt9xx_enable_dt2w_show, gt9xx_enable_dt2w_store);
